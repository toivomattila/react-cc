...
import { queryTV } from '../queries/queryInterface.js';
import { getImage } from './OutlookHelper.js';
/*
 This Component displays search results from local, traditional TV services
*/
class Ohjelmat extends Component{
  constructor(props){
    super(props)
  ...
  render(){
    ...
    */
    if(this.props.sArg.searchQuery.length === 0){
      ...
      movies = queryTV().filter(movie => movie.Title.toLowerCase().indexOf(this.props.sArg.searchQuery.toLowerCase()) !== -1);
    }
    ...
    <div className="w3-container w3-bar">
        	<h1 className="w3-bar-item ">TV-shows</h1>
      ...
      <div id="TV-shows" className={results} style={col}>
