...
import { queryRuutu } from '../queries/queryInterface.js';
import { getImage } from './OutlookHelper.js';
/*
 This Component displays search results from the Ruutu streaming service
*/
class Ruutu extends Component {
  constructor(props){
    super(props)
  ...
  render(){
    ...
    */
    if(this.props.sArg.searchQuery.length === 0){
      ...
      movies = queryRuutu().filter(movie => movie.Title.toLowerCase().indexOf(this.props.sArg.searchQuery.toLowerCase()) !== -1);
    }
    ...
    <div className="w3-container w3-bar">
        	<h1 className="w3-bar-item ">Ruutu</h1>
      ...
      <div id="Ruutu" className={results} style={col}>
