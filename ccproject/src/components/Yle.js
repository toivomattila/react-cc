...
import { queryYle } from '../queries/queryInterface.js';
import { getImage } from './OutlookHelper.js';
/*
 This Component displays search results from the Yle areena streaming service
*/
class Yle extends Component{
  constructor(props){
    super(props)
  ...
  render(){
    ...
    */
    if(this.props.sArg.searchQuery.length === 0){
      ...
      movies = queryYle().filter(movie => movie.Title.toLowerCase().indexOf(this.props.sArg.searchQuery.toLowerCase()) !== -1);
    }
    ...
    <div className="w3-container w3-bar">
        	<h1 className="w3-bar-item ">Yle</h1>
      ...
      <div id="Yle" className={results} style={col}>
